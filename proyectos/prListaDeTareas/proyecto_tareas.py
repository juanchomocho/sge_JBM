...
def marcar_tarea():
    indice = input(RESET + "Selecciona el índice de la tarea (del 0 al numero de la ulima tarea - 1): " + RED)
...
def eliminar_tarea():
    mostrar_lista()
    indice = input(RESET + "Selecciona el índice de la tarea a eliminar (del 0 al numero de la ulima tarea - 1): " + RED)
